// 상용 느낌을 위한 Unsplash 사진 세트.
// 모든 이미지는 Unsplash 라이선스(무료 상업용)로 프로토타입에 사용.

export const IMG = {
  hero: "https://images.unsplash.com/photo-1600320254374-ce2d293c324e?auto=format&fit=crop&w=1600&q=80",
  heroPhone:
  ...
  avatar1: "https://images.unsplash.com/photo-1502685104226-ee32379fefbe?auto=format&fit=crop&w=200&q=80",
  avatar2: "https://images.unsplash.com/photo-1531123897727-8f129e1688ce?auto=format&fit=crop&w=200&q=80",
  avatar3: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=200&q=80",
  avatar4: "https://images.unsplash.com/photo-1527980965255-d3b416303d12?auto=format&fit=crop&w=200&q=80",
